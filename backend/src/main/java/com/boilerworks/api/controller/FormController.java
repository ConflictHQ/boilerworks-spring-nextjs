...
public class FormController {
  ...
  public ResponseEntity<ApiResponse<List<FormDefinitionResponse>>> listDefinitions() {
    List<FormDefinitionResponse> forms =
        formService.findAllDefinitions().stream().map(FormDefinitionResponse::new).toList();
  ...
  @PreAuthorize("hasAuthority('forms.view')")
  public ResponseEntity<ApiResponse<List<FormSubmissionResponse>>> listSubmissions(
      @PathVariable UUID id) {
    List<FormSubmissionResponse> submissions =
        formService.findSubmissions(id).stream().map(FormSubmissionResponse::new).toList();
