...
public class WorkflowController {
    ...
    public ResponseEntity<ApiResponse<List<WorkflowDefinitionResponse>>> listDefinitions() {
        List<WorkflowDefinitionResponse> workflows = workflowService.findAllDefinitions().stream()
            .map(WorkflowDefinitionResponse::new)
            .toList();
    ...
    public ResponseEntity<ApiResponse<WorkflowInstanceResponse>> startInstance(@PathVariable UUID id) {
        try {
    ...
    @PreAuthorize("hasAuthority('workflows.view')")
    public ResponseEntity<ApiResponse<List<WorkflowInstanceResponse>>> listInstances(@PathVariable UUID id) {
        List<WorkflowInstanceResponse> instances = workflowService.findInstancesByDefinition(id).stream()
