...
class WorkflowServiceTest {
    ...
    void canExecuteTransitions() {
        ...
        request.setTransitionsJson(List.of(
            Map.of("name", "complete", "from", "start", "to", "end")
        ));
        ...
        WorkflowInstance updated = workflowService.executeTransition(instance.getId(), transition, null);
